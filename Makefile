...
prepare :
	...
	[ -d ckanext-kata ] || git clone https://github.com/mdlux/ckanext-kata nina-version-kata
	[ -d ckanext-oaipmh ] || git clone https://github.com/mdlux/ckanext-oaipmh nina-version
