...
prepare :
	...
	[ -d ckanext-kata ] || git clone https://github.com/mdlux/ckanext-kata -b nina-version-kata
	[ -d ckanext-oaipmh ] || git clone https://github.com/mdlux/ckanext-oaipmh -b nina-version
